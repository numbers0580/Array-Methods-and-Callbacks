...
console.log("The 2014 World Cup Final Home Team was " + games2014[0]['Home Team Name']);

console.log("Task 1b below");
console.log("The 2014 World Cup Final Away Team was " + games2014[0]['Away Team Name']);

console.log("Task 1c below");
console.log(games2014[0]['Home Team Name'] + "'s goals for the 2014 World Cup Final was " + games2014[0]['Home Team Goals']);

console.log("Task 1d below");
console.log(games2014[0]['Away Team Name'] + "'s goals for the 2014 World Cup Final was " + games2014[0]['Away Team Goals']);
